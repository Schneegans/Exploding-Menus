...
public class Menu : GLib.Object {
    ...
    private string generate_menu() {
        ...
        b.begin_object();
            ...
            b.set_member_name("subs").begin_array();
            b.begin_object(); b.set_member_name("text").add_string_value("Doppelbrötchen"); b.end_object();
            b.begin_object(); b.set_member_name("text").add_string_value("Käsebrötchen"); b.end_object();
            ...
            b.begin_object(); b.set_member_name("text").add_string_value("Weizenbrötchen"); b.end_object();
            b.end_array();
            b.end_object();
            ...
            b.begin_object(); b.set_member_name("text").add_string_value("Schokokekse"); b.end_object();
            b.begin_object(); b.set_member_name("text").add_string_value("Weihnachtskekse"); b.end_object();
            b.end_array();
            b.end_object();
            ...
            b.set_member_name("subs").begin_array();
            b.begin_object(); b.set_member_name("text").add_string_value("Blaubeertorte"); b.end_object();
            ...
            b.begin_object(); b.set_member_name("text").add_string_value("Marzipantorte"); b.end_object();
        ...
        b.begin_object();
            ...
            b.begin_object(); b.set_member_name("text").add_string_value("Holunderhonig"); b.end_object();
            b.begin_object(); b.set_member_name("text").add_string_value("Sanddornhonig"); b.end_object();
            ...
            b.set_member_name("subs").begin_array();
            b.begin_object(); b.set_member_name("text").add_string_value("Erdbeermarmelade"); b.end_object();
            b.begin_object(); b.set_member_name("text").add_string_value("Hagebuttenmarmelade"); b.end_object();
            b.begin_object(); b.set_member_name("text").add_string_value("Kirschmarmelade"); b.end_object();
            b.begin_object(); b.set_member_name("text").add_string_value("Pfirsichmarmelade"); b.end_object();
            b.begin_object(); b.set_member_name("text").add_string_value("Waldbeermarmelade"); b.end_object();
            b.end_array();
            b.end_object();
            ...
            b.set_member_name("subs").begin_array();
            b.begin_object(); b.set_member_name("text").add_string_value("Hinterschinken"); b.end_object();
            b.begin_object(); b.set_member_name("text").add_string_value("Kochschinken"); b.end_object();
            b.begin_object(); b.set_member_name("text").add_string_value("Lachsschinken"); b.end_object();
            b.begin_object(); b.set_member_name("text").add_string_value("Schwarzwäkder Schinken"); b.end_object();
        ...
        b.begin_object();
            ...
            b.begin_object(); b.set_member_name("text").add_string_value("Multivitaminsaft"); b.end_object();
        ...
        b.begin_object();
            ...
            b.begin_object(); b.set_member_name("text").add_string_value("Tiefkühl-Gemüsepfanne"); b.end_object();
            b.end_array();
            b.end_object();
